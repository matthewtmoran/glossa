...
(function () {
            ...
            return {
                ...
                link: function (scope, element, attrs, audio) {
                    ...
                    if (!scope.duration) {
                        ...
                        //dur is being passed through properly - Confirmed @@@Matt
   ...
   *    }
    ...
    //we can probably ignore this or anything that has to do with this

    //this is the player and actual audio 'graphic'
    app.directive('mdWavesurferPlayer', function () {

        return {
            restrict: 'E',
            templateUrl: 'app/audioSandbox/md-player.partial.html',
            scope: {
                src: '@url',
                title: '@',
                extraButtons: '=',
