angular.module('glossa')
    .controller('mdWavesurferAudioController', mdWavesurferAudioController);

function mdWavesurferAudioController(attributes, $element) {
    var audio = this;
    ...
    //not sure if we'll need this @@Matt
