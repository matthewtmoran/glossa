(function (root, factory) {
  ...
  var WaveSurfer = {
    ...
    loadArrayBuffer: function (arraybuffer) {
      console.log('arraybuffer 369', arraybuffer);
    ...
    loadBuffer: function (url, peaks) {
      console.log('loadbuffer loading.....');
      console.log('url', url);
    ...
    loadMediaElement: function (urlOrElt, peaks, preload) {
      console.log('loadMediaElement');
      console.log('urlOrElt', urlOrElt);
      var url = urlOrElt;
  ...
  WaveSurfer.WebAudio = {
    ...
    getOfflineAudioContext: function (sampleRate) {
      console.log('getOfflineAudioContext')
      ...
      console.log('WaveSurfer.WebAudio.offlineAudioContext', WaveSurfer.WebAudio.offlineAudioContext);
    ...
    decodeArrayBuffer: function (arraybuffer, callback, errback) {
      ...
      console.log('degub2');
      console.log('this.offlineAc', this.offlineAc);
  ...
  (function () {
    ...
    var init = function () {
      ...
      Array.prototype.forEach.call(containers, function (el) {
        ...
        console.log('loading being called?');
